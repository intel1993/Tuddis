<?php
if( !class_exists('Village_Block_Template') && class_exists('Village_Block') ) {
	class Village_Block_Template extends Village_Block {
		...
		function __construct() {
			...
			//create the block
			parent::__construct('village_block_template', $block_options);
		}
	...
	aq_register_block("Village_Block_Template");
}