...
<div id="comments" class="comments-area content__inner">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'village' ),
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use village_comment() to format the comments.
				 * If you want to override this in a child theme, then you can
				 * define village_comment() and that will be used instead.
				 * See village_comment() in inc/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'village_comment' ) );
			?>
		</ol><!-- .comment-list -->
